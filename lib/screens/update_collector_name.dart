...
class update_collector_name extends StatefulWidget {
  final id;
  final name;
  update_collector_name({Key? key, this.id, this.name}) : super(key: key);

  @override
  State<update_collector_name> createState() => _Update_addressState();
}

class _Update_addressState extends State<update_collector_name> {
