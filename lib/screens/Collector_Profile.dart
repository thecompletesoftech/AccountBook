...
import 'package:account_book/screens/update_collector_address.dart';
import 'package:account_book/screens/update_collector_mobile.dart';
import 'package:account_book/screens/update_collector_name.dart';
...
class Collector_Profile extends StatefulWidget {
  ...
  @override
  State<Collector_Profile> createState() => _Customer_profileState();
}

class _Customer_profileState extends State<Collector_Profile> {
  File? imageFile;
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                fields("Name", Icons.person, widget.name, context,
                    update_collector_name(id: widget.id, name: widget.name)),
                SizedBox(
                  height: 15,
                ),
                fields(
          ...
          Container(
            ...
            child: GestureDetector(
              onTap: () {
                showAlertDialog(context, widget.name, widget.id);
              },
              child: Container(
