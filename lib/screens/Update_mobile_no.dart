...
class Update_mobile_no extends StatefulWidget {
  final id;
  final mobile_no;
  Update_mobile_no({Key? key, this.id, this.mobile_no}) : super(key: key);

  @override
  State<Update_mobile_no> createState() => _Update_addressState();
}

class _Update_addressState extends State<Update_mobile_no> {
